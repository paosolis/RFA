...
GRAPH <- ggplot(gvol1, aes(x=Months, y=value, groupo = variable), ) + 
  ...
  geom_line(data=gvol1, aes(x=Months, y=value), color = '#8F3D38', size = 1.4) +
  geom_point(data = gvol1, aes(x=Months, y=value),color='#56070C', size = 4) +
  geom_line(data=gvol3, aes(x=Months, y=value), color = '#258D19', size = 1.3) +
  geom_point(data = gvol3, aes(x=Months, y=value),color='#007B00', size = 4.3) +
  geom_line(data=gvol6, aes(x=Months, y=value), color='#E44F9C', size = 1.2) +
  geom_point(data = gvol6, aes(x=Months, y=value),color='#C93384', size = 4.1) +
...
#legend(x = "topright", legend = c("First month", "Third month", "Sixth month",
 #                                 "Twelfth month"), fill = 
